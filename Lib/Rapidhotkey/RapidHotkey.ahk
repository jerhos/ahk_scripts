;* RapidHotkey by HotKeyIt @ https://www.autohotkey.com/board/topic/35566-rapidhotkey/

;Added include path ~ jerhos
#Include %A_lineFile%/../Morse.ahk
...
RapidHotkey(keystroke, times="2", delay=0.2, IsLabel=0)
{
    ...
    backspace := "{BS " times "}"
    keywait = Ctrl|Alt|Shift|LWin|RWin|NumpadRight
    Loop, Parse, keywait, |
        KeyWait, %A_LoopField%
